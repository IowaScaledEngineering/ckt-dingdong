...
static inline void sda_low() { DDRA |= _BV(SDA); PORTA &= ~_BV(SDA); _delay_us(1); }
static inline void sda_high() { DDRA &= ~_BV(SDA); PORTA |= _BV(SDA); _delay_us(1); }
static inline void scl_low() { PORTA &= ~_BV(SCL); _delay_us(1); }
static inline void scl_high() { PORTA |= _BV(SCL); _delay_us(1); }
